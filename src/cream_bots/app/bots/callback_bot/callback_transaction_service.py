...
from ...core.anvil_service import AnvilService
...
class CallbackTransactionService:
                    ...
                    if message["type"] == "message":
                        ...
                        if cleaned_transaction:
                            ...
                            if cleaned_transaction['to'] is None:
                                ...
                                await self.process_transaction(cleaned_transaction)
    ...
    async def process_transaction(self, transaction):
        if transaction['to'] in self.bot_state.aggregators:
            await self.process_aggregator_transaction(transaction)
    ...
    async def process_aggregator_transaction(self, transaction):
        ...
        aggregator_info = self.aggregator_service.get_aggregator_info(transaction['to'])
        if aggregator_info:
    ...
    async def print_transaction_details(self, transaction):
        ...
        log.info(f"input                 : {transaction['input']}")
